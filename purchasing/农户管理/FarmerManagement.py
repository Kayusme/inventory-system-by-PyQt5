...
main_alter_record = ''
class FarmerManagement(QWidget):
    def __init__(self, parent=None):
        super(FarmerManagement, self).__init__()
        self.setUpUI()
    ...
    def addButtonClicked(self):
        addDialog = addFarmerManagement(self)
        addDialog.show()
        addDialog.exec_()
        self.begin()
    def alterButtonClicked(self):
        ...
        alterDialog = alterFarmerManagement(self)
        alterDialog.show()
        alterDialog.exec_()
        self.begin()
...
class addFarmerManagement(QDialog):

    def __init__(self, parent=None):
        super(addFarmerManagement, self).__init__(parent)
        self.setUpUI()
...
class alterFarmerManagement(QDialog):

    def __init__(self,parent=None):
        super(alterFarmerManagement, self).__init__(parent)
        global main_alter_record
