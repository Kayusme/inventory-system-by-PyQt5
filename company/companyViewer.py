...
from company.信息设置.InformationSetup import InformationSetup
from company.物资管理.MaterialManagement import MaterialManagement
from company.生产计划.ProductionPlan import ProductionPlan
from company.用户管理.UserManagement import UserManagement
from company.统计分析.StatisticalAnalysis import StatisticalAnalysis
import sip
'''公司'''
class companyViewer(QWidget):
    ...
    def setUpUI(self):
        ...
        self.publicButton = QPushButton("信息设置")
        self.produceButton = QPushButton("统计分析")
        self.applicationButton = QPushButton("生产计划")
        self.finaButton = QPushButton("物资管理")
        self.motorButton = QPushButton("用户管理")
        ...
        self.publicButton.setFixedHeight(42)
        self.motorButton.setFixedWidth(110)
        self.motorButton.setFixedHeight(42)
        ...
        self.buttonlayout.addWidget(self.motorButton)
        ...
        self.storageView = InformationSetup()
        ...
        self.motorButton.clicked.connect(self.motorButtonClicked)
    ...
    def motorButtonClicked(self):
        self.publicButton.setStyleSheet("QPushButton{background: DimGray;}")
        self.produceButton.setStyleSheet("QPushButton{background: DimGray;}")
        self.applicationButton.setStyleSheet("QPushButton{background: DimGray;}")
        self.finaButton.setStyleSheet("QPushButton{background: DimGray;}")
        self.motorButton.setStyleSheet("QPushButton{background:  ;}")

        self.layout.removeWidget(self.storageView)
        sip.delete(self.storageView)
        self.storageView = UserManagement()
        self.layout.addWidget(self.storageView)

if __name__ == "__main__":
    app = QApplication(sys.argv)
    app.setStyleSheet(qdarkstyle.load_stylesheet_pyqt5())
    mainMindow = companyViewer(123)
    mainMindow.show()
    sys.exit(app.exec_())
