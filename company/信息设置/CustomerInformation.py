...
class CustomerInformation(QWidget):
    ...
    def addButtonClicked(self):
        addDialog = addCustomerInformation(self)
        addDialog.show()
        addDialog.exec_()
        self.begin()
    ...
    def alterButtonClicked(self):
        ...
        alterDialog = alterCustomerInformation(self)
        alterDialog.show()
        alterDialog.exec_()
        self.begin()
    ...
    def begin(self):
        ...
        for i in range(len(self.queryResults)):
            for j in range(len(self.col_lst)):
                ...
                self.tableWidget.setItem(i, j, data1)
        return
class addCustomerInformation(QDialog):

    def __init__(self, parent=None):
        super(addCustomerInformation, self).__init__(parent)
        self.setUpUI()
...
class alterCustomerInformation(QDialog):

    def __init__(self,parent=None):
        super(alterCustomerInformation, self).__init__(parent)
        global main_alter_record
...
if __name__ == "__main__":
    ...
    mainMindow = CustomerInformation()
    mainMindow.show()
    sys.exit(app.exec_())