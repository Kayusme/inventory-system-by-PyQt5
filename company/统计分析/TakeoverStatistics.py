...
class TakeoverStatistics(QWidget):
    def __init__(self, parent=None):
        super(TakeoverStatistics, self).__init__()
        self.setUpUI()
    ...
    def setUpUI(self):
        ...
        searchCondision = ['按产品编号查询', '按检验人查询', '按入库时间查询', '按片名查询', '按农户编号查询']
    ...
    def searchButtonClicked(self):
        ...
        elif (conditionChoice == "按检验人查询"):
            conditionChoice = '检验人'
        elif (conditionChoice == "按入库时间查询"):
            conditionChoice = '入库时间'
        elif (conditionChoice == "按片名查询"):
            conditionChoice = '片名'
        else:
    ...
    def deleteButtonClicked(self):
        ...
        if graph == "柱状图":
            if way=="按不同品种统计":
                ...
                self.graphResults = pd.DataFrame(self.graphResults, columns=["a", "b", "c", "d", "e", "f", "g",'h','i','j','k','l'])
            ...
            if way=="按不同品种统计":
                self.graphResults = np.array(self.queryResults)
                self.graphResults = pd.DataFrame(self.graphResults,
