...
# import qdarkstyle
import sip
from company.统计分析.SalesStatistics import SalesStatistics
from company.统计分析.CustomerPurchaseStatistics import CustomerPurchaseStatistics
from company.统计分析.TakeoverStatistics import TakeoverStatistics
class StatisticalAnalysis(QWidget):
    def __init__(self):
        super(StatisticalAnalysis, self).__init__()
        self.resize(1100, 700)
        self.setWindowTitle("欢迎使用设计管理系统")
        self.layout = QHBoxLayout()
        self.layout.setContentsMargins(1, 1, 1, 1)
        self.setLayout(self.layout)
        self.Information = StatisticalAnalysisOption()
    ...
    def productCheck(self):
        ...
        self.storageView = SalesStatistics()
        self.layout.addWidget(self.storageView)

    def materialCheck(self):
        self.layout.removeWidget(self.Information)
        sip.delete(self.Information)
        self.storageView = CustomerPurchaseStatistics()
        self.layout.addWidget(self.storageView)

    def farmerCheck(self):
        self.layout.removeWidget(self.Information)
        sip.delete(self.Information)
        self.storageView = TakeoverStatistics()
        self.layout.addWidget(self.storageView)

class StatisticalAnalysisOption(QWidget):
    is_product_signal = pyqtSignal()
    is_material_signal = pyqtSignal()
    is_farmer_signal = pyqtSignal()

    def __init__(self):
        super(StatisticalAnalysisOption, self).__init__()
        self.resize(1100, 700)
        self.setWindowTitle("欢迎使用设计管理系统")
        ...
        self.product = QPushButton("销售统计")
        self.product.setIcon(QIcon('.//image//销售统计.png'))
        self.material = QPushButton("顾客购买统计")
        self.material.setIcon(QIcon('.//image//顾客购买统计.png'))
        self.farmer = QPushButton("收购统计")
        self.farmer.setIcon(QIcon('.//image//收购统计.png'))
...
if __name__ == "__main__":
    ...
    mainMindow = StatisticalAnalysis()
    mainMindow.show()
    sys.exit(app.exec_())