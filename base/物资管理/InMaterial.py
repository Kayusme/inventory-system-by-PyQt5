...
class InMaterial(QWidget):
    def __init__(self, parent=None):
        super(InMaterial, self).__init__()
        self.setUpUI()
    def setUpUI(self):
        # 查询数据
...
class addInMaterial(QDialog):

    def __init__(self, parent=None):
        super(addInMaterial, self).__init__(parent)
        self.setUpUI()
