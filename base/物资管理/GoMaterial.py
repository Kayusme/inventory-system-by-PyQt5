...
class GoMaterial(QWidget):
    def __init__(self, parent=None):
        super(GoMaterial, self).__init__()
        self.setUpUI()
    def setUpUI(self):
        # 查询数据
...
class addGoMaterial(QDialog):

    def __init__(self, parent=None):
        super(addGoMaterial, self).__init__(parent)
        self.setUpUI()
