...
from base.产品管理.ProductManagement import ProductManagement
from base.物资管理.MaterialManagement import MaterialManagement
from base.信息查询.InformationQuery import InformationQuery
...
class baseViewer(QWidget):
    ...
    def setUpUI(self):
        ...
        self.produceButton = QPushButton("产品管理")
        self.applicationButton = QPushButton("物资管理")
        ...
        self.storageView = InformationQuery()
